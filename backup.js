        ...
        setTimeout(() => {
            ...
            connection.connect(function(err) {
                if (err) {
                    ...
                    // Une fois la connexion rétablie, réessayez d'exécuter les requêtes en attente
                    // Ici, vous pouvez ajouter la logique pour réessayer les requêtes précédentes
                }
            });
        }, 5000); // Réessayer la connexion après 5 secondes
    }
});
